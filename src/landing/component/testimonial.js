...
const Testimonial = () => {
  return (
    <>
      <div className=" bg-[#f1f1f1] md:h-[800px] w-full py-16 md:px-12 px-5">
        <p className=" text-center text-[#11305A] font-PoppinsBold font-bold text-3xl md:text-[40px] capitalize">
          Here’s What Our Customers Say About us
        </p>
        <div className=" mt-8 w-full grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-12">
